...
export default function Dashboard() {
  ...
  const { state: chainState, createChain, updateChain, deleteChain, addAccountToChain, removeAccountFromChain, reorderChainAccounts, updateAccountLimitInChain } = useChains();
